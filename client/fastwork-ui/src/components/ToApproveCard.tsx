...
// Define the interface for the ToApproveCard props
interface ToApproveCardProps {
    title: string; // Title of the job or task
    earned: string; // Amount earned or status of the job
    description: { avatar: string; username: string; review: string }[]; // Array of descriptions including avatar, username, and review
    details: string[]; // Array of details about the job
}

// Functional component for displaying a card for jobs that are to be approved
const ToApproveCard: React.FC<ToApproveCardProps> = ({ title, earned, description, details }) => {
        ...
        <div className="shadow-md rounded-md p-4 mb-4 w-72 flex-shrink-0" style={{ backgroundColor: '#CFEDF4' }}>
            ...
            <div className="flex items-center mb-2">
                ...
                <div className="text-black text-sm">
                    <span className="font-bold">{description[0].username}</span> hired you for
                </div>
            </div>

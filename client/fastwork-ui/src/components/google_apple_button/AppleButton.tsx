...
const AppleButton: React.FC<AppleButtonProps> = ({ onClick, label }) => {
    return (
        <button
            onClick={onClick}
...
export const MyAppleLoginButton: React.FC<{ onClick: () => void }> = ({ onClick }) => (
    <AppleButton onClick={onClick} label="Sign In With Apple" />
);

export const MyAppleSignUpButton: React.FC<{ onClick: () => void }> = ({ onClick }) => (
    <AppleButton onClick={onClick} label="Sign Up With Apple" />
);

...
import { Message, ActiveChat, CurrentUser } from "./chat/interfaces";
        ...
        <div className="flex flex-col w-full h-full bg-white">
            ...
            <div className="w-full bg-white">
                <div className="flex flex-col lg:flex-row">
                    ...
                    />
                    <button
                        className="lg:w-auto px-4 py-1 bg-[#0C2348] text-white rounded-lg text-xs font-semibold hover:bg-[#D0693B] focus:outline-none"
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-lg w-[400px] relative">
                        ...
                        <div className="p-4">
                            <h2 className="text-lg font-bold mb-4">
                                Which milestones do you want to pay first?
                            </h2>
                            ...
                            <div className="flex space-x-2">
                                <button
                                    className="flex-grow px-4 py-2 bg-[#E1824F] text-white rounded-lg font-semibold hover:bg-[#D0693B]"
                                    onClick={handlePayAll}
                                >
                                    Pay all at once
                                </button>
                                <button
                                    className="flex-grow px-4 py-2 bg-[#0C2348] text-white rounded-lg font-semibold hover:bg-[#D0693B]"

...
const CurrentlyEngagedOfferServicesCard: React.FC<CurrentlyEngagedCardProps> = ({ title, earned, description, details }) => {
...
export default CurrentlyEngagedOfferServicesCard;

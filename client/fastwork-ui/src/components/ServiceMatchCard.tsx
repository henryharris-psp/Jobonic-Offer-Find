...
const ServiceMatchCard: React.FC<ServiceMatchCardProps> = ({ service, onClick, onChatClick }) => {
        ...
        <div className="flex items-center space-x-1">
          ...
          {partialStarWidth > 0 && (
              <div className="relative">
                <svg className="w-4 h-4 text-gray-300" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <path d="M9.049.293a1 1 0 011.902 0l2.018 6.195h6.518a1 1 0 01.592 1.81l-5.23 3.776 2.018 6.195a1 1 0 01-1.54 1.15l-5.23-3.776-5.23 3.776a1 1 0 01-1.54-1.15l2.018-6.195-5.23-3.776a1 1 0 01.592-1.81h6.518L9.05.293z"/>
                </svg>
                <svg className="w-4 h-4 text-yellow-500 absolute top-0 left-0" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <defs>
                    <clipPath id="partialStarClip">
                      <rect x="0" y="0" width={`${partialStarWidth}%`} height="100%" />
                    </clipPath>
                  </defs>
                  <path d="M9.049.293a1 1 0 011.902 0l2.018 6.195h6.518a1 1 0 01.592 1.81l-5.23 3.776 2.018 6.195a1 1 0 01-1.54 1.15l-5.23-3.776-5.23 3.776a1 1 0 01-1.54-1.15l2.018-6.195-5.23-3.776a1 1 0 01.592-1.81h6.518L9.05.293z" clipPath="url(#partialStarClip)" />
                </svg>
              </div>
          )}
          {Array.from({ length: totalStars - fullStars - (partialStarWidth > 0 ? 1 : 0) }, (_, index) => (
              <svg key={index} className="w-4 h-4 text-gray-300" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M9.049.293a1 1 0 011.902 0l2.018 6.195h6.518a1 1 0 01.592 1.81l-5.23 3.776 2.018 6.195a1 1 0 01-1.54 1.15l-5.23-3.776-5.23 3.776a1 1 0 01-1.54-1.15l2.018-6.195-5.23-3.776a1 1 0 01.592-1.81h6.518L9.05.293z"/>
              </svg>
          ))}
        </div>
  ...
  return (
      <div
          className="relative bg-white rounded-xl p-6 shadow-md cursor-pointer hover:shadow-lg transition-shadow border border-gray-200"
          ...
          <div className="flex space-x-2 items-center justify-center">
            ...
            >
              ...
              {isWishlisted ?
                  ...
                  <svg className="w-6 h-6 text-[#0B2147] hover:text-gray-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">

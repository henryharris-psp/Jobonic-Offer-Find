...
// Define the interface for the ToSubmitFindServicesCard props
interface ToSubmitFindServicesCardProps {
    title: string; // The title of the service
    earned: string; // The earnings related to the service
...
// Functional component for displaying a card for services that need to be submitted
const ToSubmitFindServicesCard: React.FC<ToSubmitFindServicesCardProps> = ({ title, earned, description, details }) => {
    ...
    return (
        ...
        <div className="shadow-md rounded-md p-4 mb-4 w-72 flex-shrink-0" style={{ backgroundColor: '#CFEDF4' }}>
            ...
            {/* Action buttons for chat and milestone submission */}
            <div className="flex items-center">
                ...
                <button className="ml-2 px-4 py-2 bg-[#0B2147] text-white rounded-lg font-semibold hover:bg-[#D0693B]">
                    Milestone 1
                </button>
            </div>
        </div>
...
export default ToSubmitFindServicesCard;

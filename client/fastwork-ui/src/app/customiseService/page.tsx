...
const CustomiseService: React.FC = () => {
    ...
    const handleSaveDescription = async (event: React.MouseEvent) => {
        ...
        // Serialize links
        const serializedLinks = JSON.stringify(serviceData.links);
    
        // Create query string
        const queryParams = new URLSearchParams({
            profileId: String(serviceData.profileId), // Ensure it's a string
            title: serviceData.title,
            employmentType: serviceData.employmentType,
            description: serviceData.description,
            description1: serviceData.description1,
            description2: serviceData.description2,
            description3: serviceData.description3,
            languageSpoken: serviceData.languageSpoken,
            location: serviceData.location,
            categoryId: serviceData.categoryId,
            price: String(serviceData.price !== null ? serviceData.price : 0), // Convert to string; fallback to '0' if null
            priceUnit: serviceData.priceUnit,
            links: serializedLinks, // Use the serialized links here
        }).toString();
    
        // Navigate to aiServiceMatches page with the serialized query params
        try {
            const response = await httpClient.post('service', serviceData);
            console.log('Response Data:', response.data);
            
            // Redirect with query parameters
            router.push(`/aiServiceMatches?${queryParams}`);
        } catch (error) {
                ...
                <div className="w-full p-8 xs:p-8 xs:p-8 sm:p-16 lg:px-36 lg:py-10 flex flex-col gap-6 rounded-md">
                    ...
                    <div className="flex md:flex-row lg:flex-row flex-col gap-4">
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="service-title">
                                Service Title
                            </label>
                            <input
                                type="text"
                                ...
                                className="block w-full p-4 text-cyan-900 border font-medium border-gray-300 rounded-lg bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500"
                                onChange={(e) => {
                            ...
                            />
                            {titleError && <div className="text-red-500 font-medium text-sm mt-1">{titleError}</div>}
                        </div>

                        {/* Employment Type Select */}
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="employment-type">
                                Employment Type
                            </label>
                            <select
                                id="employment-type"
                            ...
                            {employmentTypeError && <div className="text-red-500 font-medium text-sm mt-1">{employmentTypeError}</div>}
                        </div>
                    </div>
                    <div className="flex md:flex-row lg:flex-row flex-col gap-4">
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="description1">Job Description 1</label>
                            <input
                                type="text"
                                id="description1"
                                value={description1}
                                placeholder="Job Description 1"
                                className="block w-full text-cyan-900 border text-sm font-medium p-4 border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                onChange={(e) => {
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="description2">Job Description 2</label>
                            <input
                                type="text"
                                id="description2"
                                value={description2}
                    ...
                    <div className="flex md:flex-row lg:flex-row flex-col gap-4">
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="description3">Job Description 3</label>
                            <input
                                type="text"
                                id="description3"
                                value={description3}
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="languages">Languages Spoken</label>
                            <div className="flex">
                                <input
                                    type="text"
                                    id="new-language"
                                    ...
                                    className="block w-[90%] text-sm font-medium p-4 text-cyan-900 border border-gray-300 rounded-lg  bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                />
                                <button
                                    onClick={handleAddLanguage}
                                    className="bg-[#0B2147] ml-4 text-white rounded-xl px-4 hover:bg-[#D0693B] font-medium text-sm "
                                >
                                    Add
                                </button>
                            </div>
                            ...
                            <div className="mt-2 flex flex-wrap">
                                {languages.map((language, index) => (
                                    <span key={index} className="inline-flex items-center bg-gray-200 rounded-full px-3 py-1 text-sm font-medium text-gray-700 mr-2 mb-2">
                                        {language}
                                        <button
                    ...
                    <div className="flex md:flex-row lg:flex-row flex-col  gap-4">
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="service-description">Service Description</label>
                            <input
                                type="text"
                                id="service-description"
                                placeholder="e.g. I can design websites..."
                                value={description}
                                className="block w-full text-sm font-medium p-4 text-cyan-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                onChange={(e) => {
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="block font-medium ml-2 mb-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="location">Location</label>
                            <input
                                type="text"
                                id="location"
                    ...
                    <div className="flex md:flex-row lg:flex-row flex-col gap-4">
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="category">Category</label>
                            <select
                                id="category"
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="asking-price">Asking Price</label>
                            <div className="flex items-center space-x-4">
                                <input
                                    type="number"
                                    id="asking-price"
                                    placeholder="Price"
                                    className="block w-[80%] text-cyan-900 border text-sm font-medium p-4 border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                    onChange={handlePriceChange}
                                />
                                <select
                                    className="block text-cyan-900 border text-sm font-medium p-4 border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                    value={priceUnit}
                    ...
                    <div className="flex md:flex-row lg:flex-row flex-col gap-4">
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="required block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="description">Offer Link Description</label>
                            <input
                                type="text"
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 mb-4">
                            <label className="block font-medium mb-2 ml-2 text-sm sm:text-sm md:text-md lg:text-lg" htmlFor="description">Website Link</label>
                            <div className="flex">
                                <input
                                    type="text"
                                    id="new-link-url"
                                    ...
                                    className="block w-[90%] text-cyan-900 border text-sm font-medium p-4 border-gray-300 rounded-lg  bg-gray-50 focus:ring-blue-500 focus:border-blue-500"

                                />
                                <button
                                    onClick={handleAddLink}
                                    className="bg-[#0B2147] ml-4 text-white font-medium rounded-xl px-4 hover:bg-[#D0693B] text-sm "
                                >
                                    Add
                                </button>
                            </div>
                                ...
                                {links.map((link, index) => (
                                    <div key={index} className="flex w-full items-center bg-gray-100 rounded-xl p-3 mb-2">
                                        <div className="flex-grow">
                                            <p className="text-sm text-cyan-900 font-medium">{link.description}</p>
                                            <a
                                                href={link.url}
                                                target="_blank"
                    ...
                    <div className="col-span-2 text-center">
                        <button
                            ...
                            className="bg-[#0B2147] hover:bg-[#D0693B] text-white font-medium py-3 px-12 text-sm rounded-2xl"

...
import MyGoogleLoginButton from '../button/MyGoogleLoginButton';
      ...
      <section className="flex flex-col items-center justify-center">
        <div className="p-8 rounded-lg shadow-md w-full max-w-3xl bg-gray-100 max-w-md">
          <div className="">
            ...
            <p className="text-sm mt-4 mb-4 text-[#002D74]"><b>If you are already a member, Easily Log in</b></p>
            <Form initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit.apply}>
              <div className="mb-5">
              ...
              <div className="text-center mb-4 mt-3">
                <Link className="inline-block text-blue-600 underline hover:text-blue-400 hover:underline pl-1 text-sm"
                      href="/forgotPassword">
            ...
            <MyGoogleLoginButton  onClick={() => handleGoogleSignIn()} />
            <MyAppleLoginButton onClick={() => handleAppleSignIn()} />
          </div>
          {/*<div className=" sm:block hidden w-1/2 p-6">*/}
          {/*  <ReactSVG src="/prog.svg" className="rounded-2xl"/>*/}
          {/*</div>*/}

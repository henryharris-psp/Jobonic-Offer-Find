...
const ServiceList = (): React.ReactElement => {
    ...
    const fetchServices = async () => {
        try {
            ...
            const filteredServices = response.data.content.filter(
                (service: any) => service.serviceRequestDTO !== null
            );

            // Map filtered services to match the expected structure for ServiceMatchCard
            const mappedServices: Service[] = filteredServices.map(
                (service: any) => ({
                    id: service.id,
                    name: service.title,
    ...
    const handleFilterApply = () => {
        ...
        console.log(
            `Filter applied with Min Price: ${minPrice}, Max Price: ${maxPrice}, Deadline: ${deadline}`
        );
            ...
            <div className="py-16 px-16">
                <section className="flex-grow">
                    <div className="max-w-7xl mx-auto text-center">
                        ...
                        <button
                            onClick={() =>
                                router.push("/customiseJobRequestForm")
                            }
                            className="mt-8 text-white py-2 px-4 rounded-lg inline-block hover:bg-[#D0693B] bg-[#0B2147]"
                        >
                        ...
                        <div className="flex justify-end space-x-4 pt-4">
                            <div className="relative">
                                ...
                                >
                                    ...
                                    {areFiltersApplied && (
                                        <svg
                                            className="w-4 h-4 text-[#0C2348] ml-2"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke="currentColor"
                        ...
                        <div className="flex pt-8">
                            <div className="job-category overflow-y-auto w-1/5 pr-4">
                                ...
                                {categoryList.map((category, index) => (
                                    <div
                                        key={index}
                                        className="py-2 border-b border-gray-400 hover:text-blue-500 cursor-pointer"
                                    >
                                        {category.name}
                                    </div>
                                ))}
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-lg p-6 w-full max-w-lg max-h-full overflow-auto">
                            ...
                            <div className="flex items-center mb-4">
                                <Image
                                    src={selectedService.profileDTO.image}
                            ...
                            <div className="max-h-96 overflow-y-auto">
                                {selectedService.reviewsDetail?.map(
                                    (review: any, index: any) => (
                                        ...
                                        >
                                            <Image
                                                ...
                                                className="rounded-full"
                                            />{" "}
                                            {/* Replace with actual reviewer image */}
                                            <div className="ml-4">

    ...
    <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md mx-auto">
      ...
      >
        ...
        <div className="flex items-center justify-center">
          <Button type="submit" variant="btn-primary flex justify-center text-white bg-[#0C2348] hover:bg-[#D0693B] focus:ring-4 focus:outline-none focus:ring-[#0C2348]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#0C2348]/55 me-2 mb-2">
            Create Account
          </Button>
        </div>

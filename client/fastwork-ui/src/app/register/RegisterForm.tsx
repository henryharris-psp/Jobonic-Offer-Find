...
const validationSchemaJobonic = Yup.object().shape({
  phoneNumber: Yup.string().required().label('First Name'),
  address: Yup.string().required().label('Last Name'),
  cardNumber: Yup.string().required().label('Last Name'),
  cardExpiryDate: Yup.string().required().label('Last Name'),
});
